...
const App = () => {
  ...
  return (
    ...
    <div class="alert  fixed-bottom" role="alert">
  Created by <a href="https://github.com/dev-deven" target="_blank" class="alert-link">Devendra Patil</a>.
</div>
    </div>
  );
};
